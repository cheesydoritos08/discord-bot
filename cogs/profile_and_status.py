...
class Profile_and_Status(commands.Cog):
    ...
    async def profile(self, ctx, *, member: discord.Member = None):
        try:
            ...
            await create_error_embed(ctx=ctx, error=e, msg=f"This occured while showing the profile of the user on line {line_num}")
    ...
    async def view_leaderboard(self, ctx, type = None):
        try:
            ...
            await create_error_embed(ctx=ctx, error=e, msg=f"This occured while viewing the leaderboard on line {line_num}")
